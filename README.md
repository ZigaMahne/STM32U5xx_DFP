...
[![License: Apache-2.0](https://img.shields.io/badge/License-Apache--2.0-green?label)](https://github.com/Open-CMSIS-Pack/STM32U5xx_DFP/blob/main/LICENSE-Apache-2.0)
[![License: BSD-3-Clause](https://img.shields.io/badge/License-BSD--3--Clause-green?label)](https://github.com/Open-CMSIS-Pack/STM32U5xx_DFP/blob/main/LICENSE-BSD-3-Clause)
...
[CMSIS/SVD](https://github.com/Open-CMSIS-Pack/STM32U5xx_DFP/tree/main/CMSIS/SVD)                  | Contains SVD files for the devices.
...
This development repository can be used in a local directory and [mapped as software pack](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/blob/main/docs/build-tools.md#install-a-repository) using for example `cpackget` with:
    ...
    cpackget add <path>/Keil.STM32U5xx_DFP.pdsc
